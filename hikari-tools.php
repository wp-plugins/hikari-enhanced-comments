...
// -------------------------------------
	...
	public static function hasNeedle($haystack,$needle){
		...
		// recursively call the function for each element of the array
		if(is_array($needle)){
			foreach($needle as $aNeedle){
				if(self::hasNeedle($haystack,$aNeedle)) return true;
			}
			return false;
		}
	...
	public static function hasNeedleInsensitive($haystack,$needle){
		...
		if(is_array($needle)){
			foreach($needle as $aNeedle){
				if(self::hasNeedleInsensitive($haystack,$aNeedle)) return true;
			}
			return false;
		}
...
class HkEC_HkToolsOptions extends HkEC_HkTools{
